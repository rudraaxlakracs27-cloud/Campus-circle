          ...
          <aside className="sidebar-column">
            <section className="panel">
              <div className="section-header">
                <div>
                  <h3>What account creation unlocks</h3>
                  <p className="muted">This is the first real auth layer inside the app.</p>
                </div>
              </div>
              <div className="list">
                <div className="list-item">
                  ...
                  <div>
                    ...
                    <div className="muted">Publish posters, captions, dates, venues, and RSVP links.</div>
                  </div>
                </div>
                <div className="list-item">
                  <div className="mini-avatar">2</div>
                  <div>
                    <strong>Interact socially</strong>
                    <div className="muted">Like, comment, and mark yourself interested in other campus events.</div>
                  </div>
                </div>
                <div className="list-item">
                  <div className="mini-avatar">3</div>
                  <div>
                    <strong>Own a profile</strong>
                    <div className="muted">Your posts and activity are tied to your real Supabase-authenticated account.</div>
                  </div>
                </div>
              </div>
            </section>
