          ...
          <aside className="sidebar-column">
            <section className="panel">
              <div className="section-header">
                <div>
                  <h3>Profile tips</h3>
                  <p className="muted">Small improvements here make your event posts feel more trustworthy.</p>
                </div>
              </div>
              <div className="list">
                <div className="list-item">
                  ...
                  <div>
                    <strong>Keep your username memorable</strong>
                    <div className="muted">A short campus identity is easier for students to recognize.</div>
                  </div>
                </div>
                <div className="list-item">
                  <div className="mini-avatar">2</div>
                  <div>
                    <strong>Write a useful bio</strong>
                    <div className="muted">Mention your role, club, or the kinds of events you usually post.</div>
                  </div>
                </div>
              </div>
            </section>
